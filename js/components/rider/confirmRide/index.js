...
class ConfirmRide extends Component {
  ...
  async handlePress() {
    console.log('rider', this.props.rider);
    ...
    */
    ...
    this.props.tripRequest.boosterSeatNum = this.state.boosterSeatNum;
    requestTrip({
      // callingSocket
  ...
  fetchTripEstimate() {
    if (this.props.tripRequest.destAddress) {
      ...
      Alert.alert('Warning', 'Enter Drop Off Location');
    }
  }
  fetchBoosterSeat() {
    this.setState({ showBoosterSeat: true });
  }
  fareEstimate() {
    return (
      <ModalView>
                ...
                <Grid style={{ paddingHorizontal: 15, marginTop: -15 }}>
                  ...
                  >
                    <Icon
                      active
                      name="pin"
                      style={{ color: commonColor.brandPrimary, fontSize: 40 }}
                    />
      ...
      <ModalView>
        ...
        >
          ...
          >
            ...
            <CardItem>
              <Grid style={{ paddingHorizontal: 5, marginTop: -15 }}>
                <Col
                  style={{
                    flexDirection: 'column',
                    alignItems: 'center',
                ...
                >
                  ...
                  >
                    <PickerItem label="0 Booster Seats" value="0" />
            ...
            <Button
              ...
              info
              onPress={() => {
                this.setState({ showBoosterSeat: false });
              }}
              style={{
                borderBottomLeftRadius: 4,
                borderBottomRightRadius: 4,
  ...
  render() {
    return (
      <View pointerEvents="box-none" style={{ flex: 1 }}>
        ...
        {this.state.showBoosterSeat ? this.boosterSeat() : null}
        ...
        <View style={styles.slideSelector}>
          <Card style={{ flexDirection: 'row', bottom: -17, left: -3 }}>
            <CardItem
